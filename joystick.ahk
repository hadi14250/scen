...
Cougar_Left := 3    ; For example, if the left Cougar MFD is registered as Joystick 3
...
CheckCougarMFD:
{
    ...
    Loop, %numButtons%
    {
        ...
        if (state = "D" and prevStateLeft[A_Index] = "U")
        {
            ...
            msg := timeStamp " - Cougar Left (Joystick " Cougar_Left "): Button " A_Index " pressed`n"
    ...
    Loop, %numButtons%
    {
        ...
        {
            FormatTime, timeStamp,, yyyy-MM-dd HH:mm:ss
            msg := timeStamp " - Cougar Right (Joystick " Cougar_Right "): Button " A_Index " pressed`n"
            FileAppend, %msg%, %logFile%
            ToolTip, %msg%
            Sleep, 200
            ToolTip
